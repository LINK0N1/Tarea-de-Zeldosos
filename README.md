...
* **US7 (Base):** *Como usuario*, quiero que las preguntas se carguen dinámicamente desde un archivo questions.json para que el contenido del cuestionario sea ampliable y modificable sin alterar el código fuente.
